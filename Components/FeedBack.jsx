...
function FeedBack() {
  ...
  const [emailData, setEmailData] = useState({
    to: "",
    subject: "Feedback Saved",
    message: `
        Welcome to EasyPG!!!!
        Thanks for Contacting Us...
        Your concern has been successfully received.
          ...
          <style>{`
            ...
            * {
            ...
            @keyframes scaleLetter {
              60% {transform: translateY(-8rem) scale(0.5, 0.5);}
              75% {transform: translateY(-8rem) scale(0.5, 0.5);}
              90% {transform: translateY(-8rem) scale(0.3, 0.5);}
              96% {transform: translateY(-8rem) scale(0.33, 0.5);}
